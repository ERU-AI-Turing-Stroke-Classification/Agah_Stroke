...
# =====================
# 🔸 EfficientNet-B2 + Linear Katman Model
# =====================
...
def train_model():
    ...
    # 🔁 Modeli baştan tanımlayıp transform değerlerini al
    temp_model = EfficientNetClassifier(num_classes=len(label_encoder.classes_))
    ...
    transform_aug = transforms.Compose([
        transforms.Resize((224, 224)),  # Tüm resimleri zorla 224x224 yap
    ...
    transform_normal = transforms.Compose([
        transforms.Resize((224, 224)),  # Burada da aynı şekilde sabitle
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.485, 0.456, 0.406],
                             std=[0.229, 0.224, 0.225])
    ])
